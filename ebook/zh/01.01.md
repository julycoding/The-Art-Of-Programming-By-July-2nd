...
不难看出，字符串长度为n，移动位置为k， 则每个元素的位置可以计算算出，即i -> (i + k) % n。[完美洗牌](https://github.com/julycoding/The-Art-Of-Programming-By-July/blob/master/ebook/zh/02.09.md)中引入了
圈的概念，将这个圈引入到字符串旋转中。比如0,1,2,3,4,5, 旋转2，则变成4,5,0,1,2,3,即
