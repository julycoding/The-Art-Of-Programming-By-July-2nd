...
当然，交换以后的问题不再等价于原问题，这个新问题的最优值用![](../images/svm/2.1.1-16.jpeg)来表示。并且，我们有![](../images/svm/2.1.1-16.jpeg)≤![](../images/svm/2.1.1-14.jpeg) ，这在直观上也不难理解，最大值中最小的一个总也比最小值中最大的一个要大。

总之，第二个问题的最优值![](../images/svm/2.1.1-16.jpeg)在这里提供了一个第一个问题的最优值![](../images/svm/2.1.1-14.jpeg)的一个下界，在满足某些条件的情况下，这两者相等，这个时候我们就可以通过求解第二个问题来间接地求解第一个问题。
