...
注：上述第3、5点性质中所说的NULL结点（包括wikipedia.算法导论上所认为的叶子结点），即为树尾端的NIL指针，或者说NULL结点。然百度百科以及网上一些其它博文直接说的叶结点，则易引起误会，因，此叶结点非子结点。
...
为了继续保持红黑树的性质，我们可以通过对结点进行重新着色，以及对树进行相关的旋转操作，即修改树中某些结点的颜色及指针结构，来达到对红黑树进行插入、删除结点等操作后，继续保持它的性质或平衡。  
