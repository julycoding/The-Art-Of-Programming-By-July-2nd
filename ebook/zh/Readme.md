...
* **第九章、系统设计**
 - [第三章续：搜索引擎热门查询统计](09.01.md)
 - [第十章：如何给 10^7 个数据量的磁盘文件排序](09.02.md)
 - [第二十二章：最短摘要的生成](09.03.md)
 - [第二十四章：倒排索引关键词 Hash 不重复编码实践](09.04.md)
 - [第二十六章：基于给定的文档生成倒排索引的编码与实践](09.05.md)
 - [第三十六~三十七章：搜索智能提示 suggestion,附近地点搜索](09.06~09.07.md)
 - [第三十八章：Hero在线编程判题、出题系统的演进与优化](09.08.md)
* **第十章、机器学习**
