...
* **第二章、数组之幻**
 - 2.1：寻找最小的 k 个数 
 - [2.2：快速选择SELECT算法的深入分析与实现](02.2.md)
 - [2.3：求数组中给定下标区间内的第 K 小(大)元素](02.3.md)
 - [2.4：动态数据中求第 K 小(大)元素](02.4.md) 「此章节为xtlx2000续写」
 - [2.5：寻找和为定值的两个数](02.5.md)
 - [2.6：寻找和为定值的多个数](02.6.md)
 - [2.7：亲和数问题--求解 500 万以内的亲和数](02.7.md)
 - [2.8：求连续子数组的最大和](02.8.md)
 - [2.9：不改变正负数之间相对顺序重新排列数组.时间 O(N),空间 O(1)](02.9.md)
