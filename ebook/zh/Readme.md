...
* **第十章、图像处理**
 - 10.1：sift算法的编译与实现
 - 10.2.1：教你一步一步用c语言实现sift算法、上
 - 10.2.2：教你一步一步用c语言实现sift算法、下
 - 10.3.1：从头到尾彻底理解傅里叶变换算法、上
 - 10.3.2：从头到尾彻底理解傅里叶变换算法、下
* **第十一章、机器学习**
 - [11.1：支持向量机通俗导论（理解SVM的三层境界）](11.01.svm.md)
 - 11.2：从K近邻算法、距离度量谈到KD树、SIFT+BBF算法 「注：只需同步此文的引言、和第一部分」
