...
![](image/8/8.2.jpg?raw=true)

  请注意，在这个继承关系中，子类没有重载任何父类的函数。那么，在派生类的实例中，

  对于实例：Derive d; 的虚函数表如下：

![](image/8/8.3.jpg?raw=true)
...
![](image/8/8.6.jpg?raw=true)

  对于子类实例中的虚函数表，是下面这个样子：

![](image/8/8.7.jpg?raw=true)
...
![](image/8/8.8.jpg?raw=true)

  下面是对于子类实例中的虚函数表的图：

![](image/8/8.9.jpg?raw=true)
