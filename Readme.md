...
# How To Contribute
 * 添补剩下的章节，参考本书[中文目录](ebook/zh/Readme.md)未完成的章节。「必选，优先级最高，目前剩2篇文章尚未同步：https://github.com/julycoding/The-Art-Of-Programming-By-July/issues/182 」
 * 一章一章的测试所有代码，指正 bug，修正错误。 「必选」
