...
另，还在谋划4本新书，类似：ChatGPT背后技术拆解(1 微积分/概率统计基础、2 ML基础/梯度上升/损失函数、3 RL基础与PPO算法、4 transformer/自注意力机制、5 GPT3/prompt学习、6 chatgpt训练三阶段/多轮对话、7 chatgpt引发的火爆)、机器学习通俗笔记、RL极简入门、AI数学基础入门，未来三年逐一出版
